...
```{r}
# before opening RStudio, do in terminal: conda activate r-reticulate
...
library(tensorflow)
# install_tensorflow(method = "conda", conda = reticulate::conda_binary(), envname = "r-reticulate")

library(keras)
# install_keras(method = "conda", conda = reticulate::conda_binary(), envname = "r-reticulate")
## -------
